...
jQuery.sap.declare('mdcontainer.lib.JSONModel');

/**
 * @class mdcontainer.lib.JSONModel
 * @extends sap.ui.model.json.JSONModel
 *
 * @property {oModel} oModel
 */
sap.ui.model.json.JSONModel.extend('mdcontainer.lib.JSONModel', /** @lends mdcontainer.lib.JSONModel.prototype */ {
  oModel: {},
